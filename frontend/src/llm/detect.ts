...
// Order matters for requests: Anthropic and Gemini use precise native shapes;
// OpenAI is the broader fallback for any `messages`-shaped body they decline.
const adapters = [anthropic, gemini, openai];
