...
export const HOTKEYS: HotkeyEntry[] = [
  ...
  // Navigation
  { keys: "j", label: "j", description: "Next event", group: "Navigation" },
  { keys: "ArrowDown", label: "\u2193", description: "Next event", group: "Navigation" },
  { keys: "k", label: "k", description: "Previous event", group: "Navigation" },
  { keys: "ArrowUp", label: "\u2191", description: "Previous event", group: "Navigation" },
  {
    keys: "ArrowRight",
    label: "\u2192",
    description: "Expand or enter child",
    group: "Navigation",
  },
  {
    keys: "ArrowLeft",
