---
name: traceloom-add-landing-icons
description: >
  Find and add technology logos/icons to the TraceLoom docs landing page.
...
This skill finds high-quality SVG logos for technology brands and integrates them into the TraceLoom docs landing page.
