"""Demo: exercise every TraceLoom capture type — HTTP, logs, and exceptions.

Run this with a TraceLoom server on :5110, then open http://localhost:5110 to see
...
resp = requests.get("https://httpbin.org/get", params={"tool": "traceloom"})
