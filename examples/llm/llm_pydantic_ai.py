"""Pydantic AI (with Anthropic) example, captured by traceloom.
...
uses httpx. So traceloom's httpx patch captures the calls, and because they hit the
Anthropic Messages API (POST /v1/messages) they render in traceloom's LLM view.
